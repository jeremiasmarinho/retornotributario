...
export const FooterSection = () => (
  <footer class="footer bg-slate-950 py-14 text-white/70">
    <div class="mx-auto max-w-6xl px-6">
      <div class="footer-content grid gap-8 border-b border-white/10 pb-10 md:grid-cols-3">
        ...
        <div class="footer-links">
          <h4 class="text-white">Menu rápido</h4>
        ...
        <div class="footer-contact space-y-2">
          <h4 class="text-white">Contato direto</h4>
          <p>
            <i class="fas fa-map-marker-alt text-amber-300"></i> Araguaína - TO
          </p>
          <p>
            <i class="fas fa-envelope text-amber-300"></i> retornotributario@gmail.com
          </p>
          <p>
      ...
      <div class="footer-bottom pt-6 text-center text-xs uppercase tracking-[0.3em] text-white/50">
        &copy; {new Date().getFullYear()} Retorno Tributário. Todos os direitos reservados.
      </div>
    </div>
  </footer>
);
