export const CtaSection = () => (
  <section
    class="section section-cta bg-gradient-to-br from-brand-black via-gray-950 to-brand-charcoal py-20 text-white"
  ...
  >
    <div class="mx-auto max-w-5xl px-6">
      <div class="cta-panel tilt-card flex flex-col items-start gap-6 rounded-[32px] bg-white/80 p-10 shadow-2xl md:flex-row md:items-center md:justify-between">
        <div class="space-y-4">
          <span class="text-xs uppercase tracking-[0.4em] text-gray-600">
            Próximo passo
          </span>
        ...
        <a
          href="#contato"
          class="btn-primary btn-glow bg-gray-900 text-white hover:bg-gray-800 whitespace-nowrap"
          data-ripple
        >
