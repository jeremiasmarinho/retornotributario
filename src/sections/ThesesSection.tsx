...
export const ThesesSection = () => (
  ...
  >
    <div className="mx-auto max-w-6xl px-6">
      ...
      <div className="teses-grid grid gap-8 lg:gap-12 md:grid-cols-2">
        {teses.map((tese, index) => (
          <article
            className="tese-card tilt-card rounded-[32px] border-l-4 border-amber-300 bg-white p-6 text-gray-950 shadow-xl"
            key={tese.title}
            data-motion="fade-up"
