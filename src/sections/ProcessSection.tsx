...
export const ProcessSection = () => (
  <section
    id="processo"
    class="section section-highlight bg-gradient-to-br from-gray-950 to-gray-900 py-20"
    ...
    <div class="mx-auto max-w-6xl px-6">
      ...
      <div class="process-grid grid gap-6 md:grid-cols-2">
        {processSteps.map((step) => (
          ...
          >
            <span class="process-step text-xs uppercase tracking-[0.4em] text-amber-200">
              {step.step}
            </span>
            <div class="process-icon my-3 flex h-12 w-12 items-center justify-center rounded-full bg-white/10 text-xl text-amber-300">
